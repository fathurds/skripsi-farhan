              ...
              <div class="row">
                <div class="col-md-12">
                  <table class="table table-bordered" style="background: #d3fffb;" id="dt">
                    <tbody>
                    <?php echo form_open('admin/jadwalAct/edit2');?>
                    <tr class="warning">
                    ...
                    <tr class="warning">
                      ...
                      <td style="background: #d3fffb;"><input type="text" name="jam" value="<?php echo $edit['jam']; ?>" placeholder="Jam" class="form-control" required=""></td>
                    </tr>                   
                    <tr class="warning">
